...
class SignUpForm(forms.Form):
    ...
    def save(self):
        ...
        Customer.objects.create(user=user, age=self.cleaned_data['age'], address=self.cleaned_data['address'],
                                phone=self.cleaned_data['phone'], name=self.cleaned_data['fullname'])
